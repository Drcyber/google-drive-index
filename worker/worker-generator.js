...
const jsURL = 'https://raw.githubusercontent.com/Drcyber/google-drive-index/master/worker/worker-beta.js;

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Drcyber Drive Index';
